...
Ironically, the authors decide here that adaptive optics probably isn't that bad after all. It can be used to extend the range of validity by correcting the higher order terms that are dropped in the binomial expansion for the optical path difference.
